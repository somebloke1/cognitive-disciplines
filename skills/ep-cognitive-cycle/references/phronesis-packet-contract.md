...
- `ep-p1-data-curator`: consolidate multiple P1 packets into one curated dataset for P2.
- `ep-p2-possibility-integrator`: consolidate multiple P2 packets into one coherent possibility set for P3.
- `ep-p3-dialectician`: consolidate multiple P3 judgments over the same possibilities into one affirmed judgment set or recursion instruction for P4/controller.
- `ep-p4-ethics-sage`: evaluate multiple P4 evaluations and decide the best authorized decision for controller finalization.
