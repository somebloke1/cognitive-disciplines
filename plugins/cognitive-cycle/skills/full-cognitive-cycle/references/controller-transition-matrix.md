...
| --- | --- | --- |
| multiple P1 | `p1-curate-evidence` | curated P1 dataset |
| multiple P2 | `p2-integrate-possibilities` | integrated P2 possibility set |
| multiple P3 | `p3-reconcile-judgments` | affirmed P3 judgment or recursion |
| multiple P4 | `p4-evaluate-decisions` | best authorized P4 decision |
